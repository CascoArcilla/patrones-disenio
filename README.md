...
Usados para la composicion de objetos, es decir, como es que se combinan las clases o interfaces para formar estructuras mas complejas.
...
Usados para la comunicacion entre objetos, es decir, como es que los objetos interactuan entre si y las responsabilidades que tienen.
...
## Información
Por lo regular, para este repositorio, cada tipo de patron tiene:
- Nombre del patrón
- Descripción
- Ejemplo
- Alguna analogía
...
- [GeekforGeeks](https://www.geeksforgeeks.org/system-design/software-design-patterns/)